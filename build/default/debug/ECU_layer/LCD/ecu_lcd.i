...
Std_ReturnType lcd_pins_4_initialize(const lcd_confg_4_t *lcd){
    ...
    else
    {
        ...
        ret = send_4_bit_command(lcd, 0x38);
        _delay((unsigned long)((5)*(4000000UL/4000.0)));
        ret = send_4_bit_command(lcd, 0x38);
        _delay((unsigned long)((150)*(4000000UL/4000000.0)));
        ret = send_4_bit_command(lcd, 0x38);
        ret = send_4_bit_command(lcd, 0x01);
        ret = send_4_bit_command(lcd, 0x02);
        ret = send_4_bit_command(lcd, 0x06);
        ret = send_4_bit_command(lcd, 0x0C);
        ret = send_4_bit_command(lcd, 0x28);
        send_4_bit_command(lcd, 0x80);
    }
        return ret;
}
Std_ReturnType send_4_bit_command(const lcd_confg_4_t *lcd, uint8 command){
...
Std_ReturnType send_4_bit_custome_char_data_pos(const lcd_confg_4_t *lcd, uint8 row,
    ...
    {
        send_4_bit_command(lcd,(0x40 + (mem_pos*8)));
        for( uint8 cnt = 0; cnt < 8; cnt++)
          ret = send_4_bit_char_data(lcd,arr[cnt]);
        send_4_bit_char_data_pos(lcd,row,column,mem_pos);
...
Std_ReturnType lcd_pins_8_initialize(const lcd_confg_8_t *lcd){
    ...
    else
    {
        ...
        _delay((unsigned long)((20)*(4000000UL/4000.0)));
        ret = send_8_bit_command(lcd, 0x38);
        _delay((unsigned long)((5)*(4000000UL/4000.0)));
        ret = send_8_bit_command(lcd, 0x38);
        _delay((unsigned long)((150)*(4000000UL/4000000.0)));
        ret = send_8_bit_command(lcd, 0x38);
        ret = send_8_bit_command(lcd, 0x01);
        ret = send_8_bit_command(lcd, 0x02);
        ret = send_8_bit_command(lcd, 0x06);
        ret = send_8_bit_command(lcd, 0x0C);
        ret = send_8_bit_command(lcd, 0x38);
...
static Std_ReturnType send_8_bit_enable(const lcd_confg_8_t *lcd){
    ...
    {
        gpio_pin_write_logic(&(lcd->en_lcd),LOW);
        _delay((unsigned long)((5)*(4000000UL/4000000.0)));
         gpio_pin_write_logic(&(lcd->en_lcd),HIGH);
    }
        return ret;
}
...
Std_ReturnType send_8_bit_custome_char_data_pos(const lcd_confg_8_t *lcd, uint8 row,
    ...
    {
        send_8_bit_command(lcd,(0x40 + (mem_pos * 8)));
        for( uint8 cnt = 0; cnt < 8; cnt++)
          ret = send_8_bit_char_data(lcd,arr[cnt]);
        send_8_bit_char_data_pos(lcd,row,column,mem_pos);
