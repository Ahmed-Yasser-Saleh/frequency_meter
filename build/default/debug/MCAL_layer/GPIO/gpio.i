...
# 28 "MCAL_layer/GPIO/../mcal_std_types.h"
...
Std_ReturnType gpio_pin_direction_intialize (const Pin_Config_t *Pin_Config){
    ...
    if(((void*)0) == Pin_Config || Pin_Config->pin > 8)
...
# 55 "MCAL_layer/GPIO/gpio.c"
Std_ReturnType gpio_pin_direction_status (const Pin_Config_t *Pin_Config,Direction_t *direction_status){
      Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == Pin_Config || ((void*)0) == direction_status || Pin_Config->pin > 8)
        ret = (Std_ReturnType)0x00;
    else
    {
        *direction_status = (*tris_reg[Pin_Config->port] >> Pin_Config->pin & (uint8)1);
    }
        return ret;
}
