...
# 79 "MCAL_layer/Interrupt/interrupt_external.h"
typedef enum{
...
# 9 "MCAL_layer/Interrupt/interrupt_external.c" 2
...
# 100 "MCAL_layer/Interrupt/interrupt_external.c"
                {
                    (INTCONbits.PEIE = 1);
                    (INTCONbits.GIE = 1);
                }
...
# 122 "MCAL_layer/Interrupt/interrupt_external.c"
                {
                    (INTCONbits.PEIE = 1);
                    (INTCONbits.GIE = 1);
                }
...
static Std_ReturnType Interrupt_INTx_Priority_Init(const interrupt_INTx_t *int_obj){
    ...
    if(((void*)0) == int_obj)
        ...
        switch(int_obj->source){
            case INTERRUPT_EXTERNAL_INT1 :
                if(0x00 == int_obj->priority){ INTERRUPT_INT1_PRIORITY_LOW(); }
                else if(0x01 == int_obj->priority){ INTERRUPT_INT1_PRIORITY_HIGH(); }
                else{ }
                ret = (Std_ReturnType)0x01;
                break;
            case INTERRUPT_EXTERNAL_INT2 :
                if(0x00 == int_obj->priority){ INTERRUPT_INT2_PRIORITY_LOW(); }
                else if(0x01 == int_obj->priority){ INTERRUPT_INT2_PRIORITY_HIGH(); }
                else{ }
                ret = (Std_ReturnType)0x01;
                break;
            default : ret = (Std_ReturnType)0x00;
...
static Std_ReturnType Interrupt_INTx_Edge_Init(const interrupt_INTx_t *int_obj){
    ...
    if(((void*)0) == int_obj)
        ...
        switch(int_obj->source){
            case INTERRUPT_EXTERNAL_INT0 :
                if(0x00 == int_obj->edge_status){ (INTCON2bits.INTEDG0 = 0); }
                else if(0x01 == int_obj->edge_status){ (INTCON2bits.INTEDG0 = 1); }
                else{ }
                ret = (Std_ReturnType)0x01;
                break;
            case INTERRUPT_EXTERNAL_INT1 :
                if(0x00 == int_obj->edge_status){ (INTCON2bits.INTEDG1 = 0); }
                else if(0x01 == int_obj->edge_status){ (INTCON2bits.INTEDG1 = 1); }
                else{ }
                ret = (Std_ReturnType)0x01;
                break;
            case INTERRUPT_EXTERNAL_INT2 :
                if(0x00 == int_obj->edge_status){ (INTCON2bits.INTEDG2 = 0); }
                else if(0x01 == int_obj->edge_status){ (INTCON2bits.INTEDG2 = 1); }
                else{ }
                ret = (Std_ReturnType)0x01;
                break;
            default : ret = (Std_ReturnType)0x00;
...
static Std_ReturnType INTX_SET_HUNDLER_INTERRUPT(const interrupt_INTx_t *int_obj){
   Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == int_obj){
        ...
        switch(int_obj->source){
            case INTERRUPT_EXTERNAL_INT0 :
                INT0_SET_HUNDLER_INTERRUPT(int_obj->externalfunction);
                ret = (Std_ReturnType)0x01;
                break;
            case INTERRUPT_EXTERNAL_INT1 :
                INT1_SET_HUNDLER_INTERRUPT(int_obj->externalfunction);
                ret = (Std_ReturnType)0x01;
                break;
            case INTERRUPT_EXTERNAL_INT2 :
                INT2_SET_HUNDLER_INTERRUPT(int_obj->externalfunction);
                ret = (Std_ReturnType)0x01;
                break;
            default : ret = (Std_ReturnType)0x00;
        }
...
# 362 "MCAL_layer/Interrupt/interrupt_external.c"
                {
                    (INTCONbits.PEIE = 1);
                    (INTCONbits.GIE = 1);
                }
