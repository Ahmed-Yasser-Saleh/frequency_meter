...
# 28 "MCAL_layer/TIMER0/../mcal_std_types.h"
...
# 17 "MCAL_layer/TIMER0/../device_config.h"
...
# 1 "MCAL_layer/TIMER0/../Interrupt/interrupt_cfg.h" 1
# 12 "MCAL_layer/TIMER0/../Interrupt/interrupt_cfg.h"
# 1 "MCAL_layer/TIMER0/../Interrupt/interrupt_generate_cfg.h" 1
# 12 "MCAL_layer/TIMER0/../Interrupt/interrupt_cfg.h" 2
# 49 "MCAL_layer/TIMER0/../Interrupt/interrupt_cfg.h"
typedef enum{
    LOW_PRIORITY,
    HIGH_PRIORITY
...
# 9 "MCAL_layer/TIMER0/timer0.c" 2
...
static Std_ReturnType select_cnt_reg_size(Timer0_cfg_t *timer0){
    ...
    {
        if(1 == timer0->cnt_register_sz)
        {
            (T0CONbits.T08BIT = 1);
        }

        else if(0 == timer0->cnt_register_sz)
        {
            (T0CONbits.T08BIT = 0);
        }
    }
...
static Std_ReturnType select_timer_mode(Timer0_cfg_t *timer0){
    ...
    else
    {
        ...
        {
            (T0CONbits.T0CS = 1);
            if(1 == timer0->timer0_counter_edge)
                (T0CONbits.T0SE = 0);

            else if(0 == timer0->timer0_counter_edge)
                (T0CONbits.T0SE = 1);
        }
    }
    return ret;
