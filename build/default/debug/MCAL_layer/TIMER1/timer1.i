...
# 28 "MCAL_layer/TIMER1/../mcal_std_types.h"
...
# 12 "MCAL_layer/TIMER1/../Interrupt/interrupt_cfg.h"
# 1 "MCAL_layer/TIMER1/../Interrupt/interrupt_generate_cfg.h" 1
# 12 "MCAL_layer/TIMER1/../Interrupt/interrupt_cfg.h" 2
# 49 "MCAL_layer/TIMER1/../Interrupt/interrupt_cfg.h"
typedef enum{
    LOW_PRIORITY,
    HIGH_PRIORITY
...
Std_ReturnType Timer1_init(Timer1_cfg_t *timer1){
  Std_ReturnType ret = (Std_ReturnType)0x01;
    ...
    else
    {
        ...
        if(timer1->timer1_osc_status == 1)
        (T1CONbits.T1OSCEN = 1);
        else if(timer1->timer1_osc_status == 0)
        (T1CONbits.T1OSCEN = 0);
...
static Std_ReturnType select_timer_mode(Timer1_cfg_t *timer1){
    ...
    {
        if(1 == timer1->timer1_mode)
           (T1CONbits.TMR1CS = 0);

        else if(0 == timer1->timer1_mode)
        {
            (T1CONbits.TMR1CS = 1);

            if(0 == timer1->timer1_counter_mode)
                (T1CONbits.T1SYNC = 0);

            else if(1 == timer1->timer1_counter_mode)
                (T1CONbits.T1SYNC = 1);
        }
    }
    return ret;
